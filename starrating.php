...
function wpcf7_enqueue_styles_awesome() {
	wp_enqueue_style( 'prefix-font-awesome', '//netdna.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', array(), '4.7.0' );
}        
...
class StarratingAwesome {
    ...
    function shortcode_handler( $tag ) {
        ...
        if( !preg_match('~^fa\-~isu',$atts['icon_class']) ){
            $atts['icon_class'] = 'fa-'.$atts['icon_class'];
        }
